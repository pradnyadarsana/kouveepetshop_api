...
Class JenisHewan extends RestController{
    ...
    public function nonAktif_get(){
        return $this->returnData($this->db->get_where('jenis_hewan', ["aktif" => 0])->result(), false);
    }
    ...
    public function search_get($id){
        return $this->returnData($this->db->get_where('jenis_hewan', ["id_jenis_hewan" => $id])->row(), false);
    }
